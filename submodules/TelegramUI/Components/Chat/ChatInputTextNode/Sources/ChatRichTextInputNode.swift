...
public protocol ChatRichTextInputNode: AnyObject {
    ...
    // MARK: NAGRAM — Backend-neutral software Return handling and Return-key appearance.
    var inputReturnKeyType: UIReturnKeyType { get set }
...
final class ChatRichTextInputNodeImpl: ASDisplayNode, ChatRichTextInputNode {
    // MARK: NAGRAM — Legacy input already routes Return through the panel delegate; keep the shared hook for
    // protocol parity with the native editor.
    ...
    // MARK: NAGRAM
    var inputReturnKeyType: UIReturnKeyType {
