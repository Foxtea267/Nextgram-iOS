...
private var declaredEncodables: Void = {
    ...
    // MARK: NAGRAM
    // MARK: NEXTGRAM
    declareEncodable(NagramMessageHistoryAttribute.self, f: { NagramMessageHistoryAttribute(decoder: $0) })
    declareEncodable(NagramDeletedMessageAttribute.self, f: { NagramDeletedMessageAttribute(decoder: $0) })
